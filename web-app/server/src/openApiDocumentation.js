const openApiDoc = {
  ...
  info: {
    version: '1.3.0',
    title: 'votarino API',
    description: 'votarino application APIs',
    termsOfService: 'http://api_url/terms/',
    contact: {
      name: 'votarino Team',
      email: 'admin@votarino.com',
      url: 'https://www.votarino.com/'
    },
    license: {
      name: 'Apache 2.0',
  ...
  paths: {
    ...
    '/logout': {
      post: {
        tags: ['Auth'],
        summary: 'logout of votarino app',
        operationId: 'logout',
        responses: {
          '200': {
            description: 'Successful operation',
  ...
  components: {
    ...
    schemas: {
      ...
      electionId: {
        ...
        example: 'xE03DFF413_votarino_Election2020'
      },
      name: {
        type: 'string',
        example: 'votarino_Election2020'
      },
      description: {
        type: 'string',
        example: 'votarino 2020 Election'
      },
      organisation: {
        type: 'string',
        example: 'votarino'
